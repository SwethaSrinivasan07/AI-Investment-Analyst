    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-[400px]">
        ...
        <div className="bg-white border border-black/8 p-8">
          <h1 className="text-[15px] font-medium text-[#121212] mb-6">Sign in</h1>
          ...
          <p className="mt-6 text-center text-[13px] text-[#5C5C5C]">
            No account?{' '}
            <Link href="/auth/signup" className="text-[#2E2A47] font-medium hover:underline transition-colors">
              Create one
            </Link>
          </p>
        </div>
